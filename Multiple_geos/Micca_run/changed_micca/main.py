import os
import helmholtz_solver.micca_pkg.os_utils as os_utils
import params

from helmholtz_solver.helmholtz_pkg.flame_transfer_function import state_space
...
# mesh_filename = os.path.join(mesh_subdir, 'Micca')
# geom_1(mesh_filename, fltk=False, **msh_params)

geometry = MeshXDMF('MeshDir/Micca', write_xdmf_file=True)
geometry()
mesh = geometry.mesh
