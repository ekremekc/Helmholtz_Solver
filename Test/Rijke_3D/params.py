...
c = dolf.Expression('x[2] <= x_f ? c_in : c_out', degree=0, x_f=x_f[0][2], c_in=c_in, c_out=c_out)

rho = dolf.Expression('x[2] <= x_f ? rho_in : rho_out', degree=0, x_f=x_f[0][2], rho_in=rho_in, rho_out=rho_out)
