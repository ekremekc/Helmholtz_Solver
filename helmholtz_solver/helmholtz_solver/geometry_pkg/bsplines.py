...
class BSpline:
    ...
    def __init__(self, P, p=3, num_of_pts=50):
...
if __name__ == '__main__':
    ...
    t = newcurve.get_t_from_point(newcurve.pts[65])
    # print(newcurve.get_curvature())
    # print(newcurve.get_displacement_from_point(4, newcurve.pts[11]))
    k = newcurve.get_curvature_from_point(newcurve.pts[65])
